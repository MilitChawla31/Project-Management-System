...
<body>
	<div class="container">
		...
		<form:form action="updateprocess" method="post" modelAttribute="project" 
			class="form">
			<div class="input-box">
				<label for="id">Project Id</label>
				<form:input  value="${id}" type="text" placeholder="Enter Project Id" path="project_id" readonly="true"/>
			...
			<div class="input-box">
				<label for="userd">User Assigned</label>
